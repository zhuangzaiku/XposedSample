...
public class HookParams {
    ...
    public static final String WECHAT_HOOK_CONFIG_NAME = "hook_config";
    ...
    public static void setInstance(HookParams instance) {
        HookParams.instance = instance;
    }
